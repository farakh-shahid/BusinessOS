...
export const DOCUMENT_PRINT_BASE_CSS = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  table.doc-table th:nth-child(4),
  table.doc-table td:nth-child(4).num { text-align: center; }
  table.doc-table td {
    padding: 9px 6px;
  ...
  table.doc-table td:first-child {
    font-size: 11.5px;
    line-height: 1.35;
  }
