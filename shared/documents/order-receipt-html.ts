...
function fabricLabel(order: OrderFullDetail, t: DocumentDictionary): string {
...
export function buildOrderReceiptHtml({
  ...
  const suitNo = order.dressCode?.trim() || order.orderNumber;
...
<body>
  ...
  <table class="doc-table">
    <thead>
      <tr>
        <th>${escapeHtml(t.receipt.measurementCardSuitNo)}</th>
