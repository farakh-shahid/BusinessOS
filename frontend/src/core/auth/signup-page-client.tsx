...
import { SignupForm } from "@/core/auth/signup-form";
  ...
  if (hasToken && isLoading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-background p-6">
        <div className="w-full max-w-[430px] space-y-4 rounded-2xl border border-hairline bg-card p-6 shadow-sm">
          <Skeleton className="mx-auto h-12 w-12 rounded-[13px] bg-hairline" />
          <Skeleton className="mx-auto h-4 w-40 rounded-md bg-hairline" />
